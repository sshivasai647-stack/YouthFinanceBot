...
import {
  LayoutDashboard, Users, Bell, LogOut, Menu
} from 'lucide-react'
import { useState } from 'react'
import { motion, AnimatePresence } from 'framer-motion'

const navItems = [
  { to: '/counsellor',          icon: LayoutDashboard, label: 'Dashboard' },
  { to: '/counsellor/citizens', icon: Users,           label: 'My Citizens' },
  { to: '/counsellor/alerts',   icon: Bell,            label: 'Alerts' },
]
  ...
  const Sidebar = ({ mobile = false }) => (
    ...
    `}>
      <div className="h-16 flex items-center gap-2 px-6 border-b
        ...
        <span className="font-bold text-lg">Counsellor</span>
      </div>
      ...
      <div className="p-4 border-t border-slate-200 dark:border-slate-700">
        <div className="flex items-center gap-3 px-3 py-2 mb-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-500 truncate">Counsellor</p>
          </div>
        </div>
        <button
